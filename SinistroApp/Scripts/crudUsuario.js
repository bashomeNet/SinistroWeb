...
jQuery(document).ready(function () {
    ...
    jQuery("#sns-busca-todos-usuarios").click(function () {
        //if (validaToken()) {
            ...
            /* Tabela montada dinamicamente no js */
            //jQuery.ajax({
...
function montaTabelaUsuarios() {
    ...
    jQuery.ajax({
        ...
        error: function (data) {
            var msgErro = 'Erro ao buscar a lista de usuários';
...
function geraToken() {
    ...
    jQuery.ajax({
        ...
        error: function (data) {
            var msgErro = 'Erro ao gerar o token de autenticação!';
            formataMsgErro(msgErro);
        }
    });
...
function buscaUsuario() {
    ...
    if (todosUsuarios.length > 0) {
        ...
        jQuery.ajax({
            ...
            error: function (data) {
                var msgErro = 'Erro ao buscar o usuário!';
                formataMsgErro(msgErro);
            }
        });
    }
...
function insereUsuario() {
    ...
    jQuery.ajax({
        ...
        error: function (data) {
            var msgErro = 'Erro ao inserir o usuário!';
            formataMsgErro(msgErro);
        }
    });
...
function atualizaUsuario() {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            var msgSucesso = 'O usuário foi atualizado com sucesso.';
            formataMsgSucesso(msgSucesso);
        },
        error: function (data) {
            var msgErro = 'Erro ao atualizar o usuário!';
            formataMsgErro(msgErro);
        }
    });
...
function deletaUsuario() {
    ...
    jQuery.ajax({
        ...
        type: "DELETE",
        success: function (data) {
            var msgSucesso = 'O usuário foi deletado com sucesso.';
            formataMsgSucesso(msgSucesso);
        },
        error: function (data) {
            var msgErro = 'Erro ao deletar o usuário!';
            formataMsgErro(msgErro);
        }
    });
